...
import 'http://minerallo.github.io/dist/style.css';
...
/*     topographySystemButton.addEventListener("click", function () {
    ...
    var milkyWayTexture = new THREE.TextureLoader().load('http://minerallo.github.io/dist/Texture_planets/Milkyway.jpg');
    ...
    for (var i = 1; i < planets.length; i++) {
        ...
        var planetTexture = new THREE.TextureLoader().load('http://minerallo.github.io/dist/Texture_planets/' + planets[i].name + '-texture.jpg');
...
/*     topographySystemButton.addEventListener("click", function () {
    ...
    for (var i = 0; i < planets.length; i++) {
        ...
        var planetTexture = new THREE.TextureLoader().load('http://minerallo.github.io/dist/Texture_planets/Earth2-texture.jpg');
        var bumpTexture = new THREE.TextureLoader().load('http://minerallo.github.io/dist/Texture_planets/Earth-bump-map.jpg');
    ...
    //const halfMaterial = new THREE.MeshBasicMaterial({ color: 0x9900ff, wireframe: true });
        ...
        var planethalfTexture = new THREE.TextureLoader().load('http://minerallo.github.io/dist/Texture_planets/Earth2-half-texture.jpg');
        var bumphalfTexture = new THREE.TextureLoader().load('http://minerallo.github.io/dist/Texture_planets/Earth-half-bump-map.jpg');
...
/*     var sphereGeometry = new THREE.SphereGeometry(0.002, 32, 32);
    ...
    for (let i = 0; i < depths.length; i += underesolved_depths) {
       ...
       // console.log("iteration i "+i)
        // Load the data file
        promises.push(fetch('http://minerallo.github.io/dist/SP12RTS_5defequid/SP12RTS..ES.' + depths[i] + '.' + 'eqdst.5.latlon.dat')
            .then(response => {
...
cvLink.addEventListener('click', function (event) {
    ...
    closePopup.addEventListener('click', function () {
        ...
        window.location.href = "http://minerallo.github.io/dist/index.html";
    });
});
...
modelGalleryLink.addEventListener('click', function () {
    ...
    window.location.href = "http://minerallo.github.io/dist/gallery.html";
    });
